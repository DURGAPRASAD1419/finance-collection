import { a as loanTotals, i as inr, o as toDMY, r as fromDMY, s as useApp } from "./app-store-B1Qbf6V1.js";
import { t as Route } from "./borrowers._borrowerId-DSWJsXpz.js";
import { i as Field, t as AppShell } from "./app-shell-CRyAR8zm.js";
import { useEffect, useMemo, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft } from "lucide-react";
//#region src/routes/borrowers.$borrowerId.tsx?tsr-split=component
function BorrowerDetailPage() {
	...
	const [loadingDueNo, setLoadingDueNo] = useState(null);
	const [editMode, setEditMode] = useState(false);
	const [collectOpen, setCollectOpen] = useState(false);
	const [paidDate, setPaidDate] = useState(toDMY(/* @__PURE__ */ new Date()));
	...
	if (!borrower) return /* @__PURE__ */ jsx(AppShell, {
	...
	return /* @__PURE__ */ jsxs(AppShell, {
		...
		children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("p", {
								...
								children: [nextDue ? /* @__PURE__ */ jsxs("div", {
						...
						}), borrowerLoans.length === 0 ? /* @__PURE__ */ jsx("p", {
									...
									children: [
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsxs("div", {
												...
												className: "mt-4 space-y-3",
												children: loan.dues.map((due) => /* @__PURE__ */ jsxs("div", {
													...
													children: [/* @__PURE__ */ jsxs("div", { children: [
														...
														children: [/* @__PURE__ */ jsx("p", {
															...
															children: [due.paid ? /* @__PURE__ */ jsx("span", {
																className: "rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700",
																children: "Paid"
															}) : /* @__PURE__ */ jsx("span", {
																className: "rounded-full bg-amber-50 px-3 py-1 text-xs font-semibold text-amber-700",
																children: "Unpaid"
															}), !due.paid ? /* @__PURE__ */ jsx("button", {
																type: "button",
			...
			collectOpen && nextDue ? /* @__PURE__ */ jsxs(Modal, {
						...
						children: [
							...
							/* @__PURE__ */ jsx(Field, {
								...
								children: /* @__PURE__ */ jsx("select", {
									...
									children: collectors.map((collector) => /* @__PURE__ */ jsx("option", {
										value: collector,
										children: collector
									}, collector))
								})
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", { children: "Borrower" }), /* @__PURE__ */ jsx("span", { children: borrower.name })]
							}),
							/* @__PURE__ */ jsxs("div", {
								className: "grid grid-cols-2 gap-2",
								children: [/* @__PURE__ */ jsx("span", { children: "Amount" }), /* @__PURE__ */ jsx("span", { children: inr(receipt.due.amount) })]
							}),
							/* @__PURE__ */ jsxs("div", {
								className: "grid grid-cols-2 gap-2",
								children: [/* @__PURE__ */ jsx("span", { children: "Paid date" }), /* @__PURE__ */ jsx("span", { children: receipt.due.paidDate })]
							}),
							/* @__PURE__ */ jsxs("div", {
								className: "grid grid-cols-2 gap-2",
								children: [/* @__PURE__ */ jsx("span", { children: "Collected by" }), /* @__PURE__ */ jsx("span", { children: receipt.due.collectedBy })]
							})
						]
					}),
					/* @__PURE__ */ jsxs("div", {
