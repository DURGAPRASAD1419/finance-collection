import { a as loanTotals, i as inr, r as fromDMY, s as useApp } from "./app-store-vl_DhqcK.js";
import { n as EmptyState, r as Fab, t as AppShell } from "./app-shell-WyGsWYV9.js";
import { useMemo, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft, Trash2 } from "lucide-react";
//#region src/routes/borrowers.index.tsx?tsr-split=component
function BorrowersPage() {
	...
	return /* @__PURE__ */ jsxs(AppShell, {
		...
		children: [
			...
			filtered.length === 0 && !query ? /* @__PURE__ */ jsx(EmptyState, { label: "No borrower matched your search." }) : /* @__PURE__ */ jsx("ul", {
					...
					return /* @__PURE__ */ jsxs("li", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								}), overdueCount ? /* @__PURE__ */ jsxs("span", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("button", {
									...
									children: [/* @__PURE__ */ jsx(Trash2, { className: "size-4" }), deletingId === b.id ? "Deleting..." : "Delete"]
								}), /* @__PURE__ */ jsx(Link, {
