import { a as loanTotals, i as inr, o as toDMY, s as useApp } from "./app-store-vl_DhqcK.js";
import { t as Route } from "./loan._loanId-BhiPhAKz.js";
import { i as Field } from "./app-shell-WyGsWYV9.js";
import { useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft, Check, HandCoins, Share2, X } from "lucide-react";
//#region src/routes/loan.$loanId.tsx?tsr-split=component
var collectors = [
	"Self",
	"Agent 1",
	"Agent 2"
...
function LoanDetailPage() {
	...
	if (!loan) return /* @__PURE__ */ jsx("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("header", {
				...
				children: [/* @__PURE__ */ jsx(Link, {
					to: "/loan",
					children: /* @__PURE__ */ jsx(ArrowLeft, { className: "size-6 text-brand" })
				}), /* @__PURE__ */ jsx(Share2, { className: "size-6 text-brand" })]
			}),
			/* @__PURE__ */ jsxs("h1", {
			...
			/* @__PURE__ */ jsxs("table", {
				...
				}) }), /* @__PURE__ */ jsx("tbody", { children: loan.dues.map((d) => /* @__PURE__ */ jsxs("tr", { children: [
					/* @__PURE__ */ jsx("td", {
			...
			nextDue && /* @__PURE__ */ jsxs("button", {
				...
				children: [/* @__PURE__ */ jsx(HandCoins, { className: "size-6" }), "COLLECT PAYMENT"]
			}),
			payOpen && nextDue && /* @__PURE__ */ jsxs(Modal, {
							...
							/* @__PURE__ */ jsx(Field, {
								...
								children: /* @__PURE__ */ jsxs("select", {
									...
									children: [/* @__PURE__ */ jsx("option", {
										value: "",
										children: "Select"
									}), collectors.map((c) => /* @__PURE__ */ jsx("option", { children: c }, c))]
								})
							})
						]
					}),
			...
			receipt && /* @__PURE__ */ jsxs(Modal, {
				...
				children: [
					/* @__PURE__ */ jsx("button", {
						...
						children: /* @__PURE__ */ jsx(X, { className: "size-8" })
					}),
					/* @__PURE__ */ jsxs("div", {
					...
					/* @__PURE__ */ jsx("div", { className: "my-6 border-t border-dashed border-border" }),
					/* @__PURE__ */ jsxs("div", {
						className: "grid grid-cols-2 gap-y-6 px-2 text-lg",
						children: [
							/* @__PURE__ */ jsx("span", { children: borrower?.name }),
							/* @__PURE__ */ jsxs("span", { children: ["Due ", receipt.no] }),
							/* @__PURE__ */ jsxs("span", { children: ["Due ", receipt.date] }),
							/* @__PURE__ */ jsxs("span", { children: ["Paid ", receipt.paidDate] })
						]
					}),
					/* @__PURE__ */ jsx("p", {
