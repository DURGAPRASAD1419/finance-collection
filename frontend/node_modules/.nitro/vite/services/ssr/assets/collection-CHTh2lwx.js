import { i as inr, o as toDMY, r as fromDMY, s as useApp } from "./app-store-vl_DhqcK.js";
import { n as EmptyState, t as AppShell } from "./app-shell-WyGsWYV9.js";
import { t as FrequencyTabs } from "./loan-ui-BBydvwfS.js";
import { useState } from "react";
import { useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft } from "lucide-react";
//#region src/routes/collection.tsx?tsr-split=component
function CollectionPage() {
	...
	return /* @__PURE__ */ jsxs(AppShell, {
		...
		children: [
			...
			rows.length === 0 ? /* @__PURE__ */ jsx(EmptyState, { label: "No collections due right now." }) : /* @__PURE__ */ jsx("ul", {
				className: "divide-y divide-border",
				children: rows.map(({ loan, due }) => /* @__PURE__ */ jsxs("li", {
