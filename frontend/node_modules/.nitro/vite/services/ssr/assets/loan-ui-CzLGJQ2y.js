import { a as loanTotals, i as inr } from "./app-store-B1Qbf6V1.js";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
//#region src/components/loan-ui.tsx
		...
		children: [
			...
			return /* @__PURE__ */ jsxs("button", {
				...
				children: [/* @__PURE__ */ jsx("span", {
					...
					children: active && /* @__PURE__ */ jsx("span", { className: "size-3 rounded-full bg-brand" })
				}), /* @__PURE__ */ jsx("span", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: [
					...
					["Pending", t.pending],
					["Balance", t.balance]
				].map(([label, val]) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
