import { n as addPeriod, o as toDMY, r as fromDMY, s as useApp } from "./app-store-D4SC5TF3.js";
import { i as Field } from "./app-shell-C5__8-G4.js";
import { t as FrequencyTabs } from "./loan-ui-DKKDAm9J.js";
import { useEffect, useMemo, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft } from "lucide-react";
//#region src/routes/loan.new.tsx?tsr-split=component
function NewLoanPage() {
	...
	const [startDate, setStartDate] = useState(toDMY(/* @__PURE__ */ new Date()));
	...
	const endDate = useMemo(() => instN ? toDMY(addPeriod(fromDMY(startDate), frequency, instN - 1)) : startDate, [
		startDate,
		frequency,
		instN
	]);
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", {
						...
						children: [/* @__PURE__ */ jsx("option", {
							value: "",
							children: "Select"
						}), borrowers.map((b) => /* @__PURE__ */ jsx("option", {
							value: b.id,
							children: b.name
						}, b.id))]
					})]
