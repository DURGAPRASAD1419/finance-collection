...
import { c as Lock, r as User } from "../_libs/lucide-react.mjs";
import { i as Field } from "./app-shell-WyGsWYV9.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DCuiCcat.js
...
function LoginPage() {
	...
	const submit = async (e) => {
		...
		try {
			if (!(await fetch(`https://finance-backend-fbbw.onrender.com/api/auth/login`, {
				method: "POST",
