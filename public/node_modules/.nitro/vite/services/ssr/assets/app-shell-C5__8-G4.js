import { a as loanTotals, i as inr, s as useApp } from "./app-store-D4SC5TF3.js";
import { useEffect, useMemo, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { BarChart3, ClipboardList, Home, IndianRupee, ListChecks, Search, Users, X } from "lucide-react";
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("header", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [headerLeft, /* @__PURE__ */ jsx("h1", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("button", {
								...
								children: /* @__PURE__ */ jsx(ClipboardList, { className: "size-5 text-brand" })
							})
						]
					})]
				}), searchOpen && activeOnSearchChange ? /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("input", {
						...
						autoFocus: true
					}), activeSearchQuery ? /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("p", {
							...
							className: "space-y-3",
							children: suggestions.map(({ borrower, totalTaken, totalPaid, totalBalance }) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("button", {
								type: "button",
								onClick: () => {
			...
			/* @__PURE__ */ jsx("nav", {
				...
				children: nav.map(({ to, label, icon: Icon }) => /* @__PURE__ */ jsxs(Link, {
					to,
					...
					children: [/* @__PURE__ */ jsx(Icon, { className: "size-6" }), /* @__PURE__ */ jsx("span", {
						className: "text-xs",
						children: label
					})]
				}, to))
